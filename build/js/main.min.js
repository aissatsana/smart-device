...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var aboutUsDescr = document.querySelector('.about-us__description--hidden');
  ...
  var accordeonButtons = document.querySelectorAll('.footer__accordeon');
  window.addEventListener('resize', function () {
    resizeWindow();
  });
  var resizeWindow = function resizeWindow() {
    if (window.innerWidth < 767) {
      accordeonButtons.forEach(function (n) {
  ...
  var _loop = function _loop(i) {
    accordeonButtons[i].addEventListener('click', function () {
      ...
      var panel = accordeonButtons[i].nextElementSibling;
  ...
  phoneInputs.forEach(function (phone) {
    var phoneMask = Object(imask__WEBPACK_IMPORTED_MODULE_2__["default"])(phone, {
